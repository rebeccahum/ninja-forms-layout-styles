	...
	<ul id="<?php echo $ul_id;?>" class="sortable ninja-forms-style-sortable cols-<?php echo $cols;?>" rel="<?php echo $cols;?>">
		...
		if( !empty( $all_fields ) ){
			foreach( $all_fields as $field ){
				...
				if( $display_function != '' ){
					?>
					<li class="ui-state-default span-<?php echo $colspan;?>" rel="<?php echo $colspan;?>" id="ninja_forms_field_<?php echo $field['id'];?>_li"><span class="style-handle"><?php echo $label;?><br />Field:<?php echo $field['id'];?></span>
						<a href="#" class="ninja-forms-style-expand ninja-forms-style-button">resize</a><br /><a href="#TB_inline?height=750&width=400&height=400&inlineId=ninja_forms_field_style_div&modal=true" class="thickbox field-styling ninja-forms-style-button" id="styling_<?php echo $field['id'];?>">styling</a>
					</li>
